...
export default function BgRemoverEditor() {
    // --- State ---
                ...
                {originalImage && !processedImage && (
                    <div className="editor-sidebar">
                        <div className="sidebar-group">
                            ...
                            >
                                <img src="https://img.icons8.com/ios-filled/50/ffffff/paint-brush.png" style={{ width: 24, height: 24, filter: 'invert(1)' }} alt="" />
                    ...
                    {!originalImage ? (
                        <div className="upload-placeholder">
                            ...
                            <div className="upload-box" onClick={() => fileInputRef.current?.click()}>
                                ...
                                <p className="text-gray-400">Click to upload an image to start editing</p>
                            </div>
                        </div>
                    ) : (
