...
import '@/app/admin/invoicing/InvoicingDashboard.css'; // Reusing the same styles for consistency
        ...
        <div className="billing-dashboard-container">
            ...
            <div className="quick-actions-section">
                ...
                <div className="quick-actions-grid">
                    ...
                    <div className="quick-action-card" onClick={() => router.push('/admin/purchase?section=purchase-lots-import')}>
