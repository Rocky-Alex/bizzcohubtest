                ...
                <div className="login-card">
                    {step === 'input' && (
                        <form onSubmit={handleLookup}>
                            ...
                            <div style={{ textAlign: 'center', marginTop: '1rem' }}>
                                <a href="/admin/login" style={{ color: '#aaa', fontSize: '0.9rem', textDecoration: 'none' }}>
                                    Back to Login
                                </a>
                            </div>
                        </form>
                    ...
                    {step === 'sent' && (
                        <div style={{ textAlign: 'center', color: 'white' }}>
                            ...
                            <a href="/admin/login" className="submit-btn" style={{ display: 'block', textDecoration: 'none', textAlign: 'center' }}>
                                Return to Login
                            </a>
                        </div>
                    )}
