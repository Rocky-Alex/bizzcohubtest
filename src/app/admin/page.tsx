...
const AccountsDashboard = dynamic(() => import("./components/AccountsDashboard"), { loading: () => <LoadingSpinner /> });
    ...
    const renderContent = () => {
        ...
        switch (activeSection) {
            ...
            case "accounts-dashboard":
                return <AccountsDashboard setActiveSection={setActiveSection} />;
            case "accounts-items":
                return <ComingSoon title="Accounts Items" description="Item management for accounts is coming soon." />;
            case "accounts-sales":
                return <ComingSoon title="Accounts Sales" description="Sales tracking and invoicing for accounts is coming soon." />;
            case "accounts-purchases":
                return <ComingSoon title="Accounts Purchases" description="Purchase orders and bill management is coming soon." />;
            case "accounts-reports":
                return <ComingSoon title="Accounts Reports" description="Financial reporting and analytics are coming soon." />;
