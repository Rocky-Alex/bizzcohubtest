...
export default function PurchaseLotDetails({ lotId, onBack }: PurchaseLotDetailsProps) {
    ...
    const fetchLotDetails = async () => {
        try {
            const response = await fetch(`/api/admin/purchase/lots/details?id=${lotId}`);
    ...
    const handleSave = async (itemId: number) => {
        try {
            ...
            const res = await fetch(`/api/admin/purchase/lots/items/${itemId}`, {
                method: 'PUT',
    ...
    const handleDelete = async (itemId: number) => {
        ...
        try {
            const res = await fetch(`/api/admin/purchase/lots/items/${itemId}`, { method: 'DELETE' });
            if (res.ok) {
