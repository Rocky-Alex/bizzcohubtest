...
export default function DatabasePage() {
    ...
    const fetchTableData = async (tableName: string, page: number) => {
        ...
        try {
            ...
            const res = await fetch(`/api/bch/database/data?table=${tableName}&limit=${limit}&offset=${offset}`);
    ...
    const handleDeleteRow = async (id: any) => {
        ...
        setConfirmModal({
            ...
            onConfirm: async () => {
                ...
                try {
                    const response = await fetch('/api/bch/database/delete-row', {
                        method: 'POST',
    ...
    const executeClear = async (tableNames: string[], displayName: string) => {
        ...
        try {
            const response = await fetch('/api/bch/database/clear', {
                method: 'POST',
                headers: { 'Content-Type': 'application/json' },
    ...
    const handleTransfer = async (direction: 'main-to-local' | 'local-to-main') => {
        ...
        setConfirmModal({
            ...
            onConfirm: async () => {
                ...
                try {
                    const response = await fetch('/api/bch/database/transfer', {
                        method: 'POST',
                        headers: { 'Content-Type': 'application/json' },
