...
export default function PurchasePage() {
    ...
    const setActiveSection = (section: string) => {
        router.push(`/bch/purchase?section=${section}`);
    };
    ...
    return (
        <div className="purchase-page-container" style={{ padding: '0.5rem' }}>
            ...
            {section === 'purchase-lots-list' && <PurchaseLotList onViewDetail={(id: number) => router.push(`/bch/purchase?section=purchase-lot-details&id=${id}`)} />}
