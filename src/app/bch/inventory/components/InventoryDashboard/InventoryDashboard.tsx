...
import '@/app/bch/invoicing/InvoicingDashboard.css'; // Reusing the same styles for consistency
...
export default function InventoryDashboard({ setActiveSection }: InventoryDashboardProps) {
    ...
    const fetchStats = React.useCallback(async () => {
        try {
            const response = await fetch('/api/bch/inventory/stats', { cache: 'no-store' });
            if (response.ok) {
        ...
        <div className="billing-dashboard-container">
            ...
            <div className="quick-actions-section">
                ...
                <div className="quick-actions-grid">
                    <div className="quick-action-card" onClick={() => setActiveSection('add-product')}>
                    ...
                    <div className="quick-action-card" onClick={() => setActiveSection('inventory-drops')}>
                    ...
                    <div className="quick-action-card" onClick={() => setActiveSection('import-products')}>
                    ...
                    <div className="quick-action-card" onClick={() => router.push('/bch/purchase?section=purchase-lots-import')}>
