...
export default function InvoicingDashboard({ setActiveSection }: InvoicingDashboardProps) {
    ...
    const fetchStats = React.useCallback(async () => {
        try {
            ...
            const response = await fetch(`/api/bch/invoices/stats?_t=${timestamp}`, { cache: 'no-store' });
            if (response.ok) {
    ...
    React.useEffect(() => {
        ...
        // Listen for global updates (like payment submissions, status changes)
        window.addEventListener('dashboard-updated', fetchStats);
        return () => window.removeEventListener('dashboard-updated', fetchStats);
    }, [fetchStats]);
            ...
            <div style={{ display: 'flex', justifyContent: 'space-between', alignItems: 'center', marginBottom: '1.5rem' }}>
                ...
                <div style={{ display: 'flex', gap: '0.75rem' }}>
                    ...
                    <button
                        onClick={async () => {
                            try {
                                const res = await fetch('/api/bch/invoices');
            ...
            <div className="quick-actions-section">
                ...
                <div className="quick-actions-grid">
                    ...
                    <div className="quick-action-card" onClick={() => setActiveSection('quotations-all')}>
                        ...
                        <div className="quick-action-content">
                            <span className="quick-action-title">All Proforma Invoices</span>
                            <span className="quick-action-desc">View all Proforma Invoices</span>
                        </div>
                    </div>
                    ...
                    <div className="quick-action-card" onClick={() => setActiveSection('quotations-new')}>
                        ...
                        <div className="quick-action-content">
                            <span className="quick-action-title">Create PROFORMA INVOICE</span>
                            <span className="quick-action-desc">Draft a new PROFORMA INVOICE</span>
                        </div>
                    </div>
