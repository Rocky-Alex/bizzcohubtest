...
import Stack from "../../landing-page/components/Stack";
...
export default function LandingHeroAntigravity() {
    ...
    return (
        <>
            ...
            {/* Hero Section */}
            <section className="hero-section-v3" style={{ background: 'transparent', zIndex: 1, pointerEvents: 'none' }}>

                <div className="hero-container">
                    <div className="hero-content fade-in-up" style={{ pointerEvents: 'auto' }}>
